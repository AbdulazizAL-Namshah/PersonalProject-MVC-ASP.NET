...
namespace MyProject.Controllers
{
    public class AboutsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,BirthDate,Website,Phone,City,Age,Degree,Email,Freelance")] About about)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,BirthDate,Website,Phone,City,Age,Degree,Email,Freelance")] About about)
        {
            if (id != about.Id)
            {
                return NotFound();
